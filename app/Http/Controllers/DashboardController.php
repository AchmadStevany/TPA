...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        WHERE transaksi.tanggal_transaksi BETWEEN '2020-12-31' AND '2021-12-31'
        ...
        $data_sampah = DB::select("SELECT detail_transaksi.quantity FROM detail_transaksi
    ...
    public function index2()
    {
        ...
        JOIN transaksi ON detail_transaksi.id_transaksi = transaksi.id
        JOIN sampah ON detail_transaksi.id_sampah = sampah.id
        WHERE transaksi.tanggal_transaksi BETWEEN '2021-12-31' AND '2022-12-31'
        GROUP BY detail_transaksi.id_transaksi,detail_transaksi.id_sampah,detail_transaksi.quantity,transaksi.tanggal_transaksi,sampah.harga_satuan");
        ...
        return view('Dashboard-2022',compact('jml_nasabah','total_pendapatan','total_sampah','data_jml_sampah','data_kategori','data_nasabah_terbaik'));
    }
}
